    ...
    <footer className="bg-white">
      <div className="max-w-7xl mx-auto px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="flex flex-col justify-center items-center sm:items-start space-y-8">
            <Logo />
            <p className="text-balance text-sm/6 text-gray-600">
              Haciendo del mundo un lugar mejor mediante la construcción de
          ...
          <div className="text-center mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        ...
        <div className="text-center mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-sm/6 text-gray-600">
            &copy; {new Date().getFullYear()} DevExplora, todos los derechos
            reservados reserved.
          </p>
        </div>
      </div>
