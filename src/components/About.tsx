  ...
  const teamMembers = [
    {
      ...
      bio: ["Apasionado por la creación de interfaces de usuario intuitivas, atractivas y altamente funcionales.",
    ...
    },
    {
      ...
      bio: ["Experto en el diseño, desarrollo y optimización de arquitecturas de servidores,", 
